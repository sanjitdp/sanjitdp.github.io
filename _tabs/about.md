...
## Nerdy stuff
This site is written in Jekyll using a modification of the `chirpy` theme and deployed using GitHub Pages. I chose to use Jekyll because it's open source, highly customizable, and makes it easy to write (all posts are written in Markdown). The math is all rendered using MathJax, a popular framework for LaTeX typesetting on the internet. There is a toggle to switch between dark mode and light mode in the sidebar.
